...
// Konfigurasi lokasi
$nama_lokasi = 'Sukamakmur';
$slug_lokasi = 'sukamakmur';
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-10 mx-auto">
                    <h2 class="section-title">Tradisi Syukuran yang Selalu Dihiasi Karangan Bunga</h2>
                    <p class="lead">Di <strong>Sukamakmur</strong>, tradisi masih menjadi bagian penting kehidupan masyarakat. Setiap syukuran panen, perayaan adat, hingga hajatan keluarga, selalu dihiasi dengan <strong>karangan bunga</strong> sebagai simbol rasa syukur dan kegembiraan. <strong>Toko bunga Sukamakmur</strong> kami bangga menjadi bagian dari tradisi ini, melayani dengan hati untuk setiap acara warga.</p>
                    
                    <h3 class="mt-4 mb-3">Karangan Bunga untuk Setiap Perayaan Komunitas</h3>
                    <p>Ketika petani merayakan panen raya, <em>papan bunga ucapan syukur</em> kami turut mewarnai perayaan. Saat ada pernikahan adat, <strong>standing flowers</strong> menghiasi pelaminan dengan anggun. Di setiap pengajian dan acara RT/RW, rangkaian bunga kami hadir sebagai ungkapan kebersamaan. Kami memahami nilai gotong royong di Sukamakmur – maka kami selalu hadir tepat waktu dengan harga yang bersahabat untuk semua kalangan.</p>
