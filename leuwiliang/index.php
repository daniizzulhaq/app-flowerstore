...
// Konfigurasi lokasi
$nama_lokasi = 'Leuwiliang';
$slug_lokasi = 'leuwiliang';
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-10 mx-auto">
                    <h2 class="section-title">Dekorasi Bunga untuk Event Corporate dan Gathering Besar</h2>
                    <p class="lead">Alam yang asri, udara segar pegunungan, dan berbagai venue outbound menjadikan <strong>Leuwiliang</strong> destinasi favorit untuk corporate gathering dan team building. <strong>Toko bunga Leuwiliang</strong> kami berpengalaman menangani dekorasi bunga untuk event skala besar – dari 50 hingga 500 orang.</p>
                    
                    <h3 class="mt-4 mb-3">Spesialis Dekorasi Event Perusahaan</h3>
                    <p>Ketika perusahaan mengadakan annual gathering, <strong>standing flowers</strong> kami menghiasi stage dan entrance dengan profesional. Saat ada acara family day, rangkaian bunga segar mempercantik setiap booth dan photo spot. Dari perusahaan multinasional hingga startup lokal, kami telah dipercaya menangani ratusan corporate event di berbagai venue Leuwiliang.</p>
