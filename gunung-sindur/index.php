...
// Konfigurasi lokasi
$nama_lokasi = 'Gunung Sindur';
$slug_lokasi = 'gunung-sindur';
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-10 mx-auto">
                    <h2 class="section-title">Melayani Setiap Momen Penting Warga dengan Bunga Segar</h2>
                    <p class="lead">Sebagai kawasan padat penduduk, <strong>Gunung Sindur</strong> memiliki dinamika kehidupan yang tinggi. Setiap hari ada kelahiran yang dirayakan, pernikahan yang digelar, hingga kepergian yang dikenang. <strong>Toko bunga Gunung Sindur</strong> kami hadir 24 jam untuk melayani setiap kebutuhan bunga warga – dari <em>buket ucapan selamat</em> hingga <em>krans duka cita</em>.</p>
                    
                    <h3 class="mt-4 mb-3">Toko Bunga 24 Jam yang Selalu Siap Melayani</h3>
                    <p>Kami paham bahwa kebutuhan akan bunga bisa datang kapan saja. Ketika ada kabar duka di malam hari, kami siap mengantar <strong>papan bunga duka cita</strong> dengan cepat dan penuh empati. Saat ada teman yang melahirkan, <em>buket bunga ucapan</em> kami bisa diantar di hari yang sama. Dengan armada pengiriman yang luas dan stok bunga segar setiap hari, kami adalah solusi tepat untuk semua kebutuhan bunga di Gunung Sindur.</p>
